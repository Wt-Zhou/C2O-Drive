...
from carla_c2osr.agents.c2osr.spatial_dirichlet import MultiTimestepSpatialDirichletBank, OptimizedMultiTimestepSpatialDirichletBank
...
class TimestepExecutor:
    ...
    def _render_timestep(self, t: int, world_current, p_plot,
        ...
        """渲染时间步热力图"""
        from carla_c2osr.visualization.vis import grid_heatmap
