...
class CarlaScenarioLibrary:
    ...
    def s5_scenario() -> ScenarioDefinition:
        ...
        metadata = {
            ...
            "agent_speed_range_mps": (1.5, 1.5),  # 对向车辆速度1.5 m/s
            "camera_position": (-40.0, -150.0),  # S5场景的固定相机位置（更新到新坐标区域）
            "agent_trajectories": {
                0: [  # 对向车辆绕行轨迹（速度1.5m/s，每步约0.2米）
                    # 对向车道直行
                    (-20.0, -138.5), (-20.2, -138.5), (-20.4, -138.5), (-20.6, -138.5), (-20.8, -138.5),
                    (-21.0, -138.5), (-21.2, -138.5), (-21.4, -138.5), (-21.6, -138.5), (-21.8, -138.5),
                    (-22.0, -138.5), (-22.2, -138.5), (-22.4, -138.5), (-22.6, -138.5), (-22.8, -138.5),
                    (-23.0, -138.5), (-23.2, -138.5), (-23.4, -138.5), (-23.6, -138.5), (-23.8, -138.5),
                    # 开始变道
                    (-24.0, -138.4), (-24.2, -138.3), (-24.4, -138.2), (-24.6, -138.0), (-24.8, -137.8),
                    (-25.0, -137.6), (-25.2, -137.4), (-25.4, -137.2), (-25.6, -137.0), (-25.8, -136.8),
                    (-26.0, -136.6), (-26.2, -136.4), (-26.4, -136.2), (-26.6, -136.0), (-26.8, -135.8),
                    (-27.0, -135.6), (-27.2, -135.5), (-27.4, -135.4), (-27.6, -135.3), (-27.8, -135.2),
                    # 完成变道，进入自车车道
                    (-28.0, -135.1), (-28.2, -135.0), (-28.4, -135.0), (-28.6, -135.0), (-28.8, -135.0),
                    # 自车车道直行
                    (-29.0, -135.0), (-29.2, -135.0), (-29.4, -135.0), (-29.6, -135.0), (-29.8, -135.0),
                    (-30.0, -135.0), (-30.2, -135.0), (-30.4, -135.0), (-30.6, -135.0), (-30.8, -135.0),
                ]
                # 静态障碍物不需要轨迹
            }
        }
