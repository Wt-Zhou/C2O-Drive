...
from c2o_drive.environments.carla.types import EgoState, AgentState, WorldState, EgoControl, AgentType
...
class TestC2OSRConfiguration:
    ...
    def test_custom_planner_config(self):
        ...
        from c2o_drive.algorithms.c2osr.config import GridConfig, QValueConfig
