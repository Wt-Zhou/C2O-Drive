...
from c2o_drive.algorithms.c2osr import create_c2osr_planner, C2OSRPlannerConfig, LatticePlannerConfig, QValueConfig
from c2o_drive.environments.carlaironments import SimpleGridEnvironment
...
def generate_report():
    ...
    report_lines.append("```python")
    report_lines.append("from c2o_drive.environments.carlaironments import CarlaEnvironment")
