...
try:
    from c2o_drive.environments.carla.types import WorldState, EgoState, AgentState, EgoControl
    print("  ✓ 项目类型定义导入成功")
except Exception as e:
    print(f"  ✗ 失败: {e}")
    import traceback
...
try:
    from c2o_drive.environments.carla.carla_scenarios import list_scenarios, get_scenario
    print("  ✓ 场景库导入成功")
...
try:
    from c2o_drive.config.global_config import CarlaConfig
